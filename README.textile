...
"Textpattern CMS":https://textpattern.com plugin tha can be used to customize the output of RSS and Atom feeds with Textpattern template tags, through a "form partial":https://docs.textpattern.com/administration/forms-panel. A form partial named @rah_feed_body@ is used to set the feed's items' body contents, allowing the use of article-context template tags like with any other template.
